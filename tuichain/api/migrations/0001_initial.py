# Generated by Django 3.1.2 on 2021-01-12 00:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requested_value_atto_dai', models.DecimalField(decimal_places=2, max_digits=8)),
                ('description', models.CharField(max_length=5000)),
                ('state', models.IntegerField(default=0)),
                ('recipient_address', models.CharField(max_length=42)),
                ('loan_identifier', models.CharField(blank=True, max_length=42, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.loan')),
            ],
        ),
        migrations.CreateModel(
